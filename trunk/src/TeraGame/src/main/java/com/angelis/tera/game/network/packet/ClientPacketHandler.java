...
import com.angelis.tera.game.network.packet.client.*;
...
public class ClientPacketHandler {
    ...
    public static final void init() {
        ...
        addPacket((short) 0xD07D, CM_ACCOUNT_AUTH.class); // OK
        addPacket((short) 0x9C7E, CM_HARDWARE_INFO.class); // OK

        // CHARACTER
        addPacket((short) 0xD488, CM_CHARACTER_LIST.class); // OK
        addPacket((short) 0x7DDA, CM_CHARACTER_CREATE_ALLOWED.class); // OK
        addPacket((short) 0xA0F5, CM_CHARACTER_CREATE_NAME_PATTERN_CHECK.class); // OK
        addPacket((short) 0xD648, CM_CHARACTER_CREATE_NAME_USED_CHECK.class); // OK
        addPacket((short) 0xD50D, CM_CHARACTER_CREATE.class); // OK
        addPacket((short) 0xDFB0, CM_CHARACTER_DELETE.class); // OK
        addPacket((short) 0x95E5, CM_CHARACTER_RESTORE.class); // OK
        
        // ENTER WORLD
        addPacket((short) 0xE2D7, CM_ENTER_WORLD.class); // OK
        addPacket((short) 0x75B7, CM_UNK_ENTER_WORLD.class); // OK
        addPacket((short) 0x6073, CM_LOAD_TOPO_FIN.class); // OK
        addPacket((short) 0x96A5, CM_UPDATE_CONTENTS_PLAYTIME.class); // OK
        addPacket((short) 0x6CC2, CM_SIMPLE_TIP_REPEATED_CHECK.class); // OK
        ...
        // PLAYER
        addPacket((short) 0xC8EE, CM_PLAYER_MOVE.class); // OK
        addPacket((short) 0xF575, CM_PLAYER_ZONE_CHANGE.class); // OK
        addPacket((short) 0xAF8D, CM_LOOKING_FOR_BATTLEGROUND_WINDOW_OPEN.class); // OK // TODO
        addPacket((short) 0x927E, CM_LOOKING_FOR_INSTANCE_WINDOW_OPEN.class); // OK // TODO
        ...
        addPacket((short) 0xA5E7, CM_PLAYER_SELECT_CREATURE.class); // OK
        ...
        // INVENTORY
        addPacket((short) 0xADE0, CM_INVENTORY_SHOW.class); // OK
        addPacket((short) 0xFC18, CM_ITEM_MOVE.class); // OK
        addPacket((short) 0xD3D3, CM_ITEM_USE.class);
        addPacket((short) 0xD1F6, CM_ITEM_SIMPLE_INFO.class); // OK
        addPacket((short) 0xEEA5, CM_INVENTORY_ORDER.class);
        addPacket((short) 0xB0FA, CM_PLAYER_UNEQUIP.class); // OK
        addPacket((short) 0xF8D3, CM_PLAYER_EQUIP.class);
        addPacket((short) 0x7FE7, CM_PLAYER_EQUIPEMENT_ITEM_INFO.class); // OK
        ...
        // SOCIAL
        addPacket((short) 0x0000, CM_PLAYER_FRIEND_LIST.class);
        ...
        addPacket((short) 0xD3DB, CM_QUIT_TO_CHARACTER_LIST.class);
        addPacket((short) 0xA999, CM_QUIT_TO_CHARACTER_LIST_CANCEL.class);
        addPacket((short) 0xAA76, CM_QUIT_GAME.class);
        ...
        // CHANNEL
        addPacket((short) 0x6784, CM_CHANNEL_LIST.class);
    }
