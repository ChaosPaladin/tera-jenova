package com.angelis.tera.login.presentation.network;
...
public class TeraLoginServer extends NanoHTTPD {
    ...
    public Response serve(final IHTTPSession httpSession) {
        ...
        switch (httpRequest.getUri()) {
            ...
            case "/shop":
                doShop(httpRequest, httpResponse);
            break;
    ...
    private void doShop(final HttpRequest httpRequest, final HttpResponse httpResponse) {
    ...
    private void doServers(final HttpRequest httpRequest, final HttpResponse response) {
        /*
         * final String uri = httpRequest.getUri(); final String lang =
