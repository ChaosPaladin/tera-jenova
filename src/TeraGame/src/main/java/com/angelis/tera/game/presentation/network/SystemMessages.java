...
public class SystemMessages {
    ...
    public static final SM_SYSTEM_MESSAGE YOU_ARE_NOT_IN_A_GROUP() {
        return new SM_SYSTEM_MESSAGE(new String[] { "@134" });
    }
    ...
    public static final SM_SYSTEM_MESSAGE FRIEND_REMOVED_YOU(final String playerName) {
        return new SM_SYSTEM_MESSAGE(new String[] { "@437", "UserName", playerName }); // NOT
                                                                                       // SURE
    }
    ...
    public static final SM_SYSTEM_MESSAGE ACCOUNT_NEW_CHARACTER_SLOT() {
