...
public class GroupService extends AbstractService {
    ...
    public void onPlayerConfirmLeaderChange(final Player oldLeader, final Player newLeader) {
        if (oldLeader.getGroup() == null || newLeader.getGroup() == null || !oldLeader.getGroup().equals(newLeader.getGroup())) {
            return;
        }
        
        final Group group = oldLeader.getGroup();
