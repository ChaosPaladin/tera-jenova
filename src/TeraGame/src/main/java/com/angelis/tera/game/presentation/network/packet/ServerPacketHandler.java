...
public class ServerPacketHandler {
    ...
    public static final void init() {
        ...
        // ENTER WORLD
        addPacket((short) 0x75BF, SM_ENTER_WORLD.class);
        addPacket((short) 0xB314, SM_LOGIN.class);
        addPacket((short) 0xF5AF, SM_CURRENT_ELECTION_STATE.class);
        addPacket((short) 0x6968, SM_AVAILABLE_SOCIAL_LIST.class);
        addPacket((short) 0x5231, SM_NPC_GUILD_LIST.class);
        addPacket((short) 0x64E8, SM_VIRTUAL_LATENCY.class);
        addPacket((short) 0x7519, SM_MOVE_DISTANCE_DELTA.class);
        addPacket((short) 0x6B75, SM_F2P_PREMIUM_USER_PERMISSION.class);
        addPacket((short) 0xA9EA, SM_PLAYER_EQUIP_ITEM_CHANGER.class);
        addPacket((short) 0xF13F, SM_FESTIVAL_LIST.class);
        addPacket((short) 0xA10B, SM_MASSTIGE_STATUS.class);
        addPacket((short) 0xDB38, SM_LOAD_TOPO.class);
        addPacket((short) 0xBC0F, SM_LOAD_HINT.class);
        addPacket((short) 0xC365, SM_SIMPLE_TIP_REPEATED_CHECK.class);
        addPacket((short) 0x58ED, SM_USER_SETTINGS_LOAD.class);
        addPacket((short) 0xA7DE, SM_MOVIE_PLAY.class);
        addPacket((short) 0x96BD, SM_VISITED_SECTION_LIST.class);
        addPacket((short) 0x7DA4, SM_TRADEBROKER_HIGHEST_ITEM_LEVEL.class);
        addPacket((short) 0x57FA, SM_ACHIEVEMENT_PROGRESS_UPDATE.class);
        ...
        // PET
        addPacket((short) 0xAED6, SM_PET_INCUBATOR_INFO_CHANGE.class);
        addPacket((short) 0x9ED0, SM_PET_INFO_CLEAR.class);
        ...
        // PLAYER
        addPacket((short) 0xD3A0, SM_PLAYER_FRIEND_LIST.class);
        addPacket((short) 0xB3A9, SM_OWN_PLAYER_SPAWN.class);
        addPacket((short) 0xAD95, SM_PLAYER_STATS_UPDATE.class);
        ...
        addPacket((short) 0xDF10, SM_PLAYER_SKILL_LIST.class);
        ...
        addPacket((short) 0x5178, SM_PLAYER_DESCRIPTION.class);
        ...
        addPacket((short) 0xAE26, SM_PLAYER_GATHER_STATS.class);
        ...
        // CRAFT
        addPacket((short) 0xAA93, SM_CRAFT_STATS.class);
        addPacket((short) 0xB070, SM_CRAFT_RECIPE_LIST.class);
        ...
        addPacket((short) 0x966E, SM_CREATURE_SPAWN.class);
        ...
        // QUEST
        addPacket((short) 0xD7D6, SM_QUEST_CLEAR_INFO.class);
        addPacket((short) 0x73D3, SM_QUEST_INFO.class);
        addPacket((short) 0xE55A, SM_QUEST_DAILY_COMPLETE_COUNT.class);
        addPacket((short) 0x6F48, SM_MISSION_COMPLETE_INFO.class);
        ...
        // INVENTORY
        addPacket((short) 0xA85C, SM_INVENTORY.class);
        ...
        addPacket((short) 0xEBC4, SM_PLAYER_APPEARANCE_CHANGE.class);
        ...
        // SYSTEM
        addPacket((short) 0xFAF4, SM_SYSTEM_MESSAGE.class);
        ...
        addPacket((short) 0x63B6, SM_PLAYER_CHANNEL_INFO.class);
